...
export default {
    ...
    methods: {
        search() {
            const number = this.searchAnggota;
            axios.get(`http://localhost/buku/selectanggota_nomor.php?nomor=${number}`)
                .then(response => {
        ...
        getAnggotaList() {
            axios.get('http://localhost/buku/select_anggota.php')
                .then(response => {
        ...
        submitForm() {
            if (this.mode === 'tambah') {
                axios.post('http://localhost/buku/inserttabel_anggota.php', this.anggota)
                    .then(response => {
                ...
                axios.put('http://localhost/buku/updateanggota_nomor.php' + this.anggota.nomor, this.anggota)
                    .then(response => {
                        console.log(response.data);
        ...
        hapusAnggota(nomor) {
            axios.delete('http://localhost/buku/deleteanggota_nomor.php' + nomor)
                .then(response => {
                    console.log(response.data);
